...
$("#shop_show").on("click",function(){
  ...
  AMap.event.addListener(marker, 'click', function() {
   ...
   //实例化信息窗体
    ...
    content.push("<a href = '#' class='diancai'><i class='iconfont icon-diancai'></i></a><a class = 'callfor' href = 'tel:"+info.tel+ "'><i class='iconfont icon-shouye'></i></a><a href = 'javascript:void(0)' class='qubei' id='test'><i class='iconfont icon-qubei aaa'></i></a>");
